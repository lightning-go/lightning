...
func (ls *logicService) Test(client *data.Client, req *msg.MsgTestReq, ack *msg.MsgTestAck) int {
	ack.Result = req.N * 1000
	return msg.RESULT_OK
}

func (ls *logicService) Test2(client *data.Client, req *msg.MsgTest2Req, ack *msg.MsgTest2Ack) int {
	ack.Result = req.N * 1000
	return msg.RESULT_OK
}

func (ls *logicService) Test3(client *data.Client, req *msg.MsgTestCenterReq) int {
